...
(b=g.getAttribute("data-requiremodule")),h=F[g.getAttribute("data-requirecontext")])}(h?h.defQueue:S).push([b,c,d])};define.amd={jQuery:!0};h.exec=function(b){return eval(b)};h(r)}})(this);if(window.sysinfo.family=="v"){try{if(window.console&&window.console.log){console.log("%c欢迎使用微擎公众平台管理系统 ^_^ ：","height:25px; line-height:25px;");console.log("%c1，一款免费开源的公众平台管理系统\n2，基于目前最流行的WEB2.0的架构（php+mysql）\n3，源码透明、开放，保证独立性、安全性及可控性\n4，拥有超强的扩展性能和活跃的第三方开发者\n5，良好的开发框架、文档，轻松扩展、定制私有功能\n","color:green;line-height:25px;");console.log("%c微擎官方网站：http://www.we7.cc","color:red");console.log("%c微擎官方论坛：http://bbs.we7.cc","color:blue")}}catch(e){};
}
var requireConfig = {
