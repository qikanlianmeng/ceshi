...
<div id="js-goods-seller" ng-controller="goodsSellerCtrl" ng-cloak>
	...
	<ul class="we7-page-tab">
		...
		<li <?php  if($type == STORE_TYPE_ACCOUNT) { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('goodsSeller', array('type' => STORE_TYPE_ACCOUNT,'direct' => '1'))?>">账号个数</a></li>
		<li <?php  if($type == STORE_TYPE_ACCOUNT_RENEW) { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('goodsSeller', array('type' => STORE_TYPE_ACCOUNT_RENEW,'direct' => '1'))?>">账号续费</a></li>
