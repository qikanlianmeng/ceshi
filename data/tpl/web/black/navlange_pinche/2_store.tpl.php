...
?>
<ol class="breadcrumb">
    <?php  if($op == 'edit' OR $op == 'wx' OR $op == 'admin' OR $op == 'post') { ?>
    <li>
...
<link rel="stylesheet" type="text/css" href="<?php  echo $_W['siteroot'];?>addons/navlange_reserve_show/template/style/qc_font/iconfont.css?&v=4">
<?php  if($op == 'index') { ?>
	<div class="panel panel-default">
	    ...
	    <div class="panel-body">
			...
			<table class="table table-condensed table-striped" style="background-color: white;table-layout:fixed;word-wrap:break-word">
				...
				<tbody>
					<?php  if(is_array($store)) { foreach($store as $index => $item) { ?>
						<tr id="<?php  echo $item['id'];?>">
                            <td>
                                <input id="order_index_<?php  echo $item['id'];?>" type="number" class="form-control" value="<?php  echo $item['order_index'];?>" onchange="set_order_index(<?php  echo $item['id'];?>)" style="padding-left:0px;padding-right:0px;text-align: center" />
                            </td>
                            ...
                            <td style="text-align: center">
                                <input type="checkbox" name="is_default_<?php  echo $item['id'];?>" value="1" <?php  if($item['is_default']=='1') { ?>checked<?php  } ?> onchange="set_default(<?php  echo $item['id'];?>)" />
                            </td>
                            <?php  } ?>
                            <td style="text-align: center">
                                <?php  echo $item['total_income'];?>/<?php  echo $item['deduct_income'];?>
                            </td>
                            <td style="text-align: center">
							...
							<td style="text-align: center">
                                ...
                                <?php  if($permission == 'ADMIN') { ?>
								<a href="javascript:delete_store(<?php  echo $item['id'];?>)" style="color:red"><i class="fa fa-trash"></i></a>
                                <?php  } ?>
							</td>
						</tr>
					<?php  } } ?>
...
<div class="panel panel-info">
    ...
    <div class="panel-body">
        <?php  if(!empty($mc_member)) { ?>
        <form class="form-horizontal" role="form" action="" method="POST">
            <div class="form-group">
                <label for="name" class="col-sm-2 control-label">微信头像</label>
                <div class="col-sm-10">
                    <img src="<?php  echo $mc_member['avatar'];?>" width="30px" height="30px" style="border-radius: 15px" />
                </div>
            </div>
            <div class="form-group">
                <label for="name" class="col-sm-2 control-label">微信昵称</label>
                <div class="col-sm-10">
                    <input class="form-control" disabled="true" value="<?php  echo $mc_member['nickname'];?>">
                </div>
            </div>
            <div class="form-group">
                <label for="name" class="col-sm-2 control-label">真实姓名</label>
                <div class="col-sm-10">
                    <input class="form-control" disabled="true" value="<?php  echo $mc_member['realname'];?>">
                </div>
            </div>
            <div class="form-group">
                <label for="name" class="col-sm-2 control-label">联系电话</label>
                <div class="col-sm-10">
                    <input class="form-control" disabled="true" value="<?php  echo $mc_member['mobile'];?>">
                </div>
            </div>
            <div class="form-group">
...
<div class="panel panel-warning">
    ...
    <div class="panel-body">
        <?php  if($store['admin_uid']>0) { ?>
        <form class="form-horizontal" role="form" action="" method="POST">
            <div class="form-group">
                <label class="col-sm-2 control-label">用户名</label>
                <div class="col-sm-10">
                    <div class="input-group">
                        <input name="username" value="<?php  echo $store['username'];?>" type="text" class="form-control" placeholder="请输入商店登入用户名" />
            ...
            function update_username() {
                if($("input[name='username']").val() == '') {
                    ...
                    $.post("<?php  echo $this->createWeburl('store',array('op'=>'update_username'))?>",{
                            ...
                            admin_uid:<?php  echo $store['admin_uid'];?>
                        },function(resp) {
                            resp = $.parseJSON(resp);
                            if(resp.message.errno == 0) {
                                alert("修改成功！");
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <div class="input-group">
                        <input name="password" value="<?php  echo $store['password'];?>" type="password" type="text" class="form-control" placeholder="请输入商店登入密码" />
	...
	<div class="panel-body">
	    <form class="form-horizontal" role="form" action="" method="POST">
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input name="name" value="<?php  echo $store['name'];?>" type="text" class="form-control" placeholder="请输入商家名称" />
				</div>
		  	</div>
		  	<div class="form-group">
                <label class="col-sm-2 control-label">商家编号</label>
                <div class="col-sm-10">
                    <input name="sn" value="<?php  echo $store['sn'];?>" type="text" class="form-control" placeholder="请输入商家编号" />
                </div>
            </div>
            <div class="form-group">
				<label class="col-sm-2 control-label">商家联系电话</label>
				<div class="col-sm-10">
					<input name="tel" type="text" value="<?php  echo $store['tel'];?>" class="form-control" placeholder="请输入商家联系电话" />
				</div>
		  	</div>
		  	<div class="form-group">
		  	...
		  	<div class="form-group">
                ...
                <div class="col-sm-10">
                    <textarea class="form-control" name="intro" placeholder="请输入商家简介"><?php  echo $store['intro'];?></textarea>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <div class="col-sm-2" style="padding-left:0px"><input id="lng" name="lng" value="<?php  echo $store['lng'];?>" class="form-control" /></div>
                    <div class="col-sm-2" style="padding-left:0px"><input id="lat" name="lat" value="<?php  echo $store['lat'];?>" class="form-control" /></div>
                </div>
            </div> 
            ...
            <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <div data-toggle="distpicker"><!-- container -->
                            <select name="prov" data-province="<?php  echo $store['prov'];?>"></select><!-- 省 -->
                            <select name="city" data-city="<?php  echo $store['city'];?>"></select><!-- 市 -->
                            <select name="district" data-district="<?php  echo $store['district'];?>"></select><!-- 区 -->
                        </div>
                    </div>
                </div>
                <script>
                    var requireExtend = require.config({
                        paths: {
                            'distpicker': '<?php  echo $_W['siteroot'];?>addons/navlange_reserve_show/template/style/js/distpicker', //结尾不写.js
                            'distpicker.data': '<?php  echo $_W['siteroot'];?>addons/navlange_reserve_show/template/style/js/distpicker.data', //结尾不写.js
                        },
                        shim:{
                             //依赖
                            'distpicker' : {
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input name="address" value="<?php  echo $store['address'];?>" class="form-control" placeholder="请输入商家地址">
                </div>
            </div>
            <div class="form-group">
                <label for="name" class="col-sm-2 control-label">qq</label>
                <div class="col-sm-10">
                    <input name="qq" value="<?php  echo $store['qq'];?>" class="form-control" placeholder="请输入商家qq">
                </div>
            </div> 
            <div class="form-group">
                <label for="name" class="col-sm-2 control-label">email</label>
                <div class="col-sm-10">
                    <input name="email" value="<?php  echo $store['email'];?>" class="form-control" placeholder="请输入商家email">
                </div>
            </div>
            <div class="form-group">
                <label for="name" class="col-sm-2 control-label">微信号</label>
                <div class="col-sm-10">
                    <input name="wx" value="<?php  echo $store['wx'];?>" class="form-control" placeholder="请输入商家微信号">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <select class="form-control" name="status">
                        <option <?php  if($store['status']=='0') { ?>selected<?php  } ?> value="0">待审核</option>
                        <option <?php  if($store['status']=='1') { ?>selected<?php  } ?> value="1">已审核</option>
                    </select>
                </div>
            </div>
			<div class="form-group">
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <div style="min-height: 50px">
            <?php  if(is_array($qualification_gallery)) { foreach($qualification_gallery as $index => $item) { ?>
                <b id="qualification_gallery_<?php  echo $item['id'];?>">
                    <img style="max-width: 300px" src="<?php  echo tomedia($item['img']);?>" class="img-thumbnail">
                    <label style="margin-left:-40px;width:40px;font-size:20px;color:red;cursor: pointer;" onclick="delete_qualification_gallery(<?php  echo $item['id'];?>)"><i class="fa fa-minus-circle"></i></label>
                </b>
            <?php  } } ?>
        </div>
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <div style="min-height: 50px">
            <?php  if(is_array($gallery)) { foreach($gallery as $index => $item) { ?>
                <b id="gallery_<?php  echo $item['id'];?>">
                    <img style="max-width: 300px" src="<?php  echo tomedia($item['img']);?>" class="img-thumbnail">
                    <label style="margin-left:-40px;width:40px;font-size:20px;color:red;cursor: pointer;" onclick="delete_gallery(<?php  echo $item['id'];?>)"><i class="fa fa-minus-circle"></i></label>
                </b>
            <?php  } } ?>
        </div>
        <div class="panel panel-default" style="margin-top:20px">
