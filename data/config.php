...
$config['db']['master']['username'] = 'cx_wx_aigoyx_co';
$config['db']['master']['password'] = 'cx.wx.aigoyx.com';
$config['db']['master']['port'] = '3306';
$config['db']['master']['database'] = 'cx_wx_aigoyx_co';
...
$config['setting']['authkey'] = 'f80b55b8';
